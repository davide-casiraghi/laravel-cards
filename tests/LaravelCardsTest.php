...
class LaravelCardsTest extends TestCase
{
    ...
    public function it_gets_cards_snippet_occurances()
    {
        ...
        foreach ($snippet_occurances as $key => $snippet_occurance) {
            $this->assertEquals(6, $snippet_occurance[2]);
            $this->assertEquals('right', $snippet_occurance[4]);
            $this->assertEquals(3, $snippet_occurance[6]);
            $this->assertEquals('#345642', $snippet_occurance[8]);
            $this->assertEquals('#212529', $snippet_occurance[10]);
            $this->assertEquals('false', $snippet_occurance[12]);  
        }
